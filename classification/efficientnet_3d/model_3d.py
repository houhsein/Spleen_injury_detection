...
class MBConvBlock3D(nn.Module):
    ...
    def forward(self, inputs, drop_connect_rate=None):
        ...
        # Skip connection and drop connect (random drop input tensor)
...
class EfficientNet3D(nn.Module):
    ...
    Example:
        ...
        import torch
        >>> from efficientnet.model import EfficientNet3D
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        for block_args in self._blocks_args:
            ...
            self._blocks.append(MBConvBlock3D(block_args, self._global_params, image_size=image_size))
    ...
    def extract_endpoints(self, inputs):
        ...
        for idx, block in enumerate(self._blocks):
            ...
            if prev_x.size(2) > x.size(2):
                ...
                endindex['reduction_{}'.format(len(endindex)+1)] = idx
            prev_x = x
    ...
    @classmethod
    def from_name(cls, model_name, in_channels=3, normal=True, **override_params):
        ...
        blocks_args, global_params = get_model_params(model_name, normal, override_params)
